...
public:
    ...
    /**
     * Log the regular minute sample to the measurements log.
     * Format: "YYYY-MM-DDTHH:MM:SSZ,temperature,value,°C,session_id,source,global_id"
     */
     ...
     */
    void log_event(time_t timestamp, const char *event_name, unsigned long elapsed_seconds, float temperature, bool temperature_valid, unsigned long event_id, LogLevel level = LogLevel::Info);
